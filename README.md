...
- `` backend for auth, sessions, messages, internal EMI tools, PDF extraction, and LLM orchestration
...
- `frontend/`
  - Simple multi-screen operator UI
  - Signup/login
...
npm i 
cp .env.example .env
update the env with correct credentials 
npm run start
```
